...
main(int argc, char* argv[])
{
	...
	cl_mem dSumx4 = clCreateBuffer(Context, CL_MEM_READ_ONLY, xySize, NULL, &status);
	cl_mem dSumx3 = clCreateBuffer(Context, CL_MEM_READ_ONLY, xySize, NULL, &status);
	...
	cl_mem dSumx2y = clCreateBuffer(Context, CL_MEM_READ_ONLY, xySize, NULL, &status);
